  ...
  if (!material) {
    return (
      <div className="text-center py-20">
        <h2 className="text-xl font-bold text-white">Material lot not found</h2>
        <p className="text-xs text-slate-400 mt-2">The listing you requested may have been fulfilled or decommissioned.</p>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="rounded-2xl overflow-hidden border border-slate-800 bg-slate-900 shadow-card">
            <div className="relative h-80 sm:h-96 lg:h-[420px] w-full bg-slate-950 overflow-hidden">
              <img
              ...
              <div className="absolute top-4 left-4 flex gap-2 flex-wrap">
                <Badge variant="default" size="sm" className="bg-slate-900/90 backdrop-blur-md border-slate-700 text-white font-medium">
                  {material.category}
                </Badge>
              ...
              {material.inspectionCertificate && (
                <div className="absolute bottom-4 left-4 flex items-center gap-2 bg-slate-900/90 backdrop-blur-md px-3 py-1.5 rounded-xl border border-slate-700/80 text-xs text-slate-200">
            ...
            {material.images && material.images.length > 1 && (
              <div className="p-3 bg-slate-950/70 border-t border-slate-800 flex gap-3">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-400">{material.condition} Condition</span>
            </div>
          ...
          <Card className="p-6 space-y-5 border-emerald-500/30 bg-slate-900/90">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between text-xs font-medium">
                <span className="text-slate-300">Select Quantity:</span>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="w-10 h-10 rounded-xl bg-slate-800 hover:bg-slate-750 border border-slate-700 text-white flex items-center justify-center font-bold transition disabled:opacity-40 disabled:cursor-not-allowed"
                >
                ...
                <div className="flex-1 relative">
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 focus:border-emerald-500 rounded-xl py-2 px-3 text-center text-sm font-bold text-white focus:outline-none"
                  />
            ...
            <div className="space-y-2.5 pt-2">
              <Button
                size="lg"
                variant="primary"
                className="w-full justify-center text-sm font-bold shadow-lg shadow-emerald-500/20"
          ...
          <Card className="p-5 space-y-4 bg-slate-900/60">
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
              <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">
                Seller Facility
              </span>
              <span className="inline-flex items-center gap-1 text-[10px] font-semibold text-emerald-400 bg-emerald-950/80 border border-emerald-500/30 px-2.5 py-0.5 rounded-full">
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <h4 className="text-sm font-bold text-white">{material.companyName || material.sellerName}</h4>
                <p className="text-xs text-slate-400 mt-0.5">{material.location || material.sellerLocation}</p>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-800/80 text-xs">
              <div className="p-2.5 rounded-lg bg-slate-950/60 border border-slate-800">
                <span className="text-[10px] text-slate-500 block">Facility Rating</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-4">
          ...
          <Card className="p-6 sm:p-8 space-y-4">
            ...
            <div className="p-4 rounded-xl bg-slate-950/60 border border-slate-800/80 space-y-2 mt-4">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Loading protocol: <span className="text-slate-200 font-medium">{material.pickupType || 'Dock Height / Forklift Assisted'}</span>. Palletized and strapped for standard dry van or flatbed freight pickup.
              </p>
            </div>
          </Card>
          ...
          <Card className="p-6 sm:p-8 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 text-xs">
              {specifications.map((spec, idx) => (
                ...
                >
                  <span className="text-slate-400 text-[11px] font-medium">{spec.label}</span>
        ...
        <div className="space-y-6">
          <Card className="p-6 space-y-6 bg-gradient-to-b from-emerald-950/30 via-slate-900 to-slate-900 border-emerald-500/25">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <Leaf className="w-5 h-5 text-emerald-400" />
                <h3 className="text-base font-bold text-white">Circular Impact</h3>
              </div>
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
                ...
                <p className="text-[11px] text-slate-500">Redirected from waste disposal sites</p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
                ...
                <p className="text-[11px] text-slate-500">Displaces virgin resource extraction</p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
                ...
                <p className="text-[11px] text-slate-500">EPA WARM 15.0 emissions credit</p>
              </div>
            </div>

            <div className="pt-2 text-center">
              <Link to="/impact" className="text-xs text-emerald-400 hover:text-emerald-300 font-medium inline-flex items-center gap-1">
      ...
      >
        {isSuccess ? (
          <div className="p-6 text-center space-y-4 animate-fade-in">
            ...
            <div>
              <h4 className="text-lg font-bold text-white">Material Request Dispatched!</h4>
              <p className="text-xs text-slate-400 mt-1 leading-relaxed max-w-sm mx-auto">
                Your inquiry for <span className="text-white font-semibold">{quantity} {material.unit}</span> has been sent to <span className="text-white font-semibold">{material.companyName || material.sellerName}</span> with escrow protection.
              </p>
            </div>

            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 text-xs text-left space-y-1.5 font-mono">
              <div className="flex justify-between">
                <span className="text-slate-500">Order Reference:</span>
                <span className="text-emerald-400 font-bold">CE-2026-RQ{Math.floor(1000 + Math.random() * 9000)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-500">Escrow Subtotal:</span>
                <span className="text-white font-bold">{formatCurrency(estimatedTotal, 'INR')}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-500">Pickup Date:</span>
                <span className="text-slate-300">{requestForm.pickupDate}</span>
              </div>
            </div>
          ...
          <form onSubmit={handleSendRequest} className="space-y-4 text-xs">
            ...
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-bold text-white text-right truncate max-w-[200px]">{material.title || material.name}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">Requested Quantity:</span>
                <span className="font-bold text-emerald-400">{quantity} {material.unit}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">Estimated Total:</span>
                <span className="font-bold text-white font-mono">{formatCurrency(estimatedTotal, 'INR')}</span>
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-900 border border-slate-800 rounded-xl p-2.5 text-white text-xs focus:outline-none focus:border-emerald-500 cursor-pointer"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-slate-900 border border-slate-800 rounded-xl p-3 text-white text-xs focus:outline-none focus:border-emerald-500 placeholder-slate-500"
